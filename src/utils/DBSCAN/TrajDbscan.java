 ...
 * @since 3.2
 */
public class TrajDbscan<T extends Clusterable> extends Clusterer<T> {
     ...
     */
    public TrajDbscan(final double eps, final int minPts)
    ...
    private List<T> getNeighbors(final T point, final Collection<T> points) {
        ...
        for (final T neighbor : points) {
            if (point != neighbor && this.distance(neighbor, point) <= eps) {
    ...
    public double distance(Clusterable a, Clusterable b){
    	Trajectory aa = (Trajectory)a;
    	Trajectory bb = (Trajectory)b;
